"use strict";
(self["webpackChunksc_library"] = self["webpackChunksc_library"] || []).push([["public_js_admin_js"],{
...
function setupAdminMain() {
    ...
    $("#circulation-report-link").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/report?type=circulation');
    });

    $("#purchases-report-link").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/report?type=purchases');
    });

    $("#removed-report-link").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/report?type=removed');
    });

    $("#inventory-link").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/inventory');
    });
    ...
    $("#view-all-books").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/view?type=books');
    });

    $("#view-all-users").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/view?type=users');
    });

    $("#barcode-link").on("click", () => {
        (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)('admin/barcode');
    });
...
function buildUserBox(obj, page, num = 0) {
    ...
    if (page == "edit-entry" || page == "view") {
        div.addEventListener("click", () => {
            (0,_ajax__WEBPACK_IMPORTED_MODULE_1__.goToPage)("admin/editUser?id=" + obj.cardNumber);
        });
...
//# sourceMappingURL=public_js_admin_js.bundle.js.map
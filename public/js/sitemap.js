function sitemapSetup() {
    var folder = "", blacklist = ['404', 'autogenindex'];
    for (var i = 0; i < directory.length; i++) {
        ...
        if (slash != -1) {
            ...
            folder = newFolder;
            $('#' + folder).append("<li><a onclick='javascript:goToPage(\"" + page + "\");'>" + formatPageString(page) + "</a></li>");
        } else {
            folder = "";
            $('#sitemap').append("<li><a onclick='javascript:goToPage(\"" + page + "\");'>" + formatPageString(page) + "</a></li>");
        }
    }
...
function buildAdminSitemap() {
    ...
    for (var i = 0; i < directory.length; i++) {
        ...
        if (slash != -1) {
            ...
            page = page.substring(slash + 1);
            if (newFolder != "admin") continue;
            $('#admin').append("<li><a onclick='javascript:goToPage(\"" + page + "\");'>" + formatPageString(page) + "</a></li>");
        }
    }
}
